          ...
          <div className="col-lg-9 bg-blue-grad d-flex left_content p-0 m-0 position-relative">
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  onClick={nextPage}
                  disabled={!itemTypeCart('Motor', cartItems)}
                >
            ...
            <div className="part_modal w-100 input-form">
              <div className="content">
                ...
                {/* {InputForm('motor', categories, motor, result, onchange)} */}
                ...
                <div className="find_product text-white">
                  {result.length > 0
                    ? ResultComponent('Motor', result, handleSelect, cartItems)
                    : null}
                </div>
              </div>
            </div>
